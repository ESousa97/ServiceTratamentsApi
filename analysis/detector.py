...
DOMAIN_SYNONYMS = {
  ...
  'oferta': ['Oferta', 'Offer', 'Special Deal'],
  ...
  'lancamento': ['Lançamento', 'Launch', 'New Product'],
  ...
  'endereco': ['Endereço', 'Address', 'Logradouro', 'Rua', 'Street', 'Avenida', 'Av', 'Endereços'],
  ...
  'rede': ['Rede', 'Chain', 'Network', 'Retail Chain'],
